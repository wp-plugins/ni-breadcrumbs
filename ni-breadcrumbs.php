...
/*
Plugin Name: NI Breadcrumbs
Plugin URI: http://www.networkintellect.com
Description: Very simple Breadcrumbs Plugin Created By Peter Featherstone @ Network Intellect
Version: 1.0
Author: Peter Featherstone
Text Domain: ni-breadcrumbs
Author URI: http://www.networkintellect.com
License: GPL2
Tags: breadcrumbs, ni, ni breadcrumbs
...
@package  WordPress NI Breadcrumbs
...
|--------------------------------------------------------------------------
|
| This bootstraps the NI Breadcrumbs and gets it ready for use, then it
| will load up the NI Breadcrumbs application so that we can run it.
|
*/
...
| which will setup everything we need to display the NI Breadcrumbs 
